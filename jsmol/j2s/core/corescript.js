...
this.ichCurrentCommand = this.cchScript;
...
if (this.isNewSet && n > 2 && this.tokAt (2) == 1073742336 && (this.tokAt (3) == 1275068435 || this.tokAt (3) == 1140850693 || this.tokAt (3) == 1275335685 || this.tokAt (3) == 1275334673)) {
this.ltoken.set (0, JS.T.tokenSet);
this.ltoken.add (1, this.tokAt (3) == 1275334673 ? JS.T.tokenAll : this.ltoken.get (1));
...
if (this.flowContext != null && this.flowContext.checkForceEndIf (-1)) {
if (this.isComment) {
if (this.flowContext.addLine > 0) {
this.flowContext.addLine++;
this.flowContext.forceEndIf = true;
}} else if (n > 0) {
this.forceFlowEnd (this.flowContext.token);
if (this.lastFlowContext.addLine > 0) {
this.lastFlowContext.forceEndIf = true;
}}this.isEndOfCommand = true;
this.cchToken = 0;
this.ichCurrentCommand = this.ichToken;
if (n > 0) this.lineCurrent--;
return 2;
}this.isComment = false;
this.isShowCommand = false;
++this.lineCurrent;
...
Clazz_defineMethod (c$, "wasImpliedScript", 
 function () {
if (this.nTokens >= 2 && (this.tokCommand == 134222853 || this.tokCommand == 4124) && this.checkImpliedScriptCmd) {
...
if (this.nTokens == 1 && (this.tokCommand == 134320137 || this.tokCommand == 102436 || this.tokCommand == 36868) || this.nTokens != 0 && isUserVar || !this.isDotDot && this.isUserFunction (this.identLC) && ((preserveCase = this.ident) != null) && (this.thisFunction == null || !this.thisFunction.name.equals (this.identLC))) {
...
var str = this.getUnescapedStringLiteral (this.lastToken != null && !this.iHaveQuotedString && this.lastToken.tok != 1073741983 && (this.tokCommand == 36867 && this.nTokens == 2 && this.lastToken.tok == 545259546 || this.tokCommand == 134222851 || this.tokCommand == 1610616835 || this.tokCommand == 134222853 || this.tokCommand == 4124));
this.iHaveQuotedString = true;
if ((this.tokCommand == 134222851 || this.tokCommand == 135174) && this.lastToken.tok == 134221832 || this.tokCommand == 134221832 && str.indexOf ("@") < 0) {
if (!this.getData (str)) {
...
return 2;
}}if (!this.iHaveQuotedString && this.lookingAtImpliedString (this.tokCommand == 134222350, this.tokCommand == 134222851, this.nTokens > 1 || this.tokCommand != 134222853 && this.tokCommand != 4124)) {
var str = this.script.substring (this.ichToken, this.ichToken + this.cchToken);
if (this.tokCommand == 134222853) {
...
if (this.implicitString && !((this.tokCommand == 134222853 || this.tokCommand == 4124) && this.iHaveQuotedString) && this.lookingAtImpliedString (true, true, true)) {
var str = this.script.substring (this.ichToken, this.ichToken + this.cchToken);
if (this.tokCommand == 1825200140 && JU.PT.isOneOf (str.toLowerCase (), ";on;off;hide;display;")) this.addTokenToPrefix (JS.T.getTokenFromName (str.toLowerCase ()));
...
if (this.theTok == 134320137 || this.theTok == 102436) {
return 2;
}break;
case 134320648:
if (this.nTokens == 1) {
...
this.newContextVariable (this.ident);
break;
}if ((this.nTokens == 3 || this.nTokens == 4) && this.theTok == 1275068417) {
this.nSemiSkip -= 2;
this.forPoint3 = 2;
this.addTokenToPrefix (this.theToken);
this.theToken = JS.T.tokenLeftParen;
...
this.lastFlowContext = this.flowContext;
this.setCommand (JS.T.o (102409, "end"));
...
if (token.tok != 134320137 && token.tok != 102436 && token.tok != 364558) this.addTokenToPrefix (token);
this.setCommand (t0);
return 2;
}, "JS.T");
...
isEnd = true;
if (this.flowContext.token.tok != 134320137 && this.flowContext.token.tok != 102436 && this.flowContext.token.tok != 364558) this.setCommand (JS.T.tv (this.tokCommand, (this.flowContext.ptDefault > 0 ? this.flowContext.ptDefault : -this.flowContext.pt0), ident));
break;
case 364558:
case 102412:
break;
...
case 102402:
case 364547:
if (this.lastFlowContext != null && this.lastFlowContext.forceEndIf && this.lastFlowContext.addLine > 0) {
this.flowContext = this.lastFlowContext;
this.flowContext.forceEndIf = true;
if (this.isFlowIfContextOK (this.flowContext, this.tokCommand) && this.lltoken.get (this.iCommand - 1)[0].tok == 102409) this.lltoken.remove (pt = --this.iCommand);
}if (this.flowContext != null && !this.isFlowIfContextOK (this.flowContext, this.tokCommand)) this.flowContext = this.flowContext.parent;
if (!this.isFlowIfContextOK (this.flowContext, this.tokCommand)) return this.errorStr (1, ident);
this.flowContext.token.intValue = this.flowContext.setPt0 (pt, false);
break;
case 364548:
isEnd = true;
if (this.flowContext == null || this.flowContext.token.tok != 134320649 && this.flowContext.token.tok != 102439 && this.flowContext.token.tok != 364547 && this.flowContext.token.tok != 102402) return this.errorStr (1, ident);
break;
case 102407:
case 102408:
isNew = false;
...
case 102411:
case 102413:
if (this.flowContext == null || this.flowContext.token.tok != 102410 && this.flowContext.token.tok != 102411 && (this.tokCommand == 102413 ? this.flowContext.ptDefault > 0 : this.flowContext.token.tok != 102413)) return this.errorStr (1, ident);
...
if (this.tokCommand == 364548) this.flowContext = this.flowContext.parent;
} else if (isNew) {
...
return (f != null && (f.token.tok == 134320649 || f.token.tok == 102402 || f.token.tok == 364547 && tokCommand != 364547));
...
this.addTokenToPrefix (JS.T.o (134221832, str));
...
case 102409:
if (statement.length == 2 && (statement[1].tok == 134320137 || statement[1].tok == 102436)) return ((statement[1].value)).toString ();
}
var useBraces = true;
var inBrace = false;
...
if (this.theToken != null && cmdLine.length > 0 && !cmdLine.equals (lastCommand) && (this.theToken.tok == 134320137 || this.theToken.tok == 102436 || !JS.T.tokAttr (this.theToken.tok, 102400))) this.vwr.addCommand (lastCommand = cmdLine);
...
if (this.slen == 1 && this.st[0].tok != 134320137 && this.st[0].tok != 102436) continue;
} else {
...
var filename = null;
var bsModels;
var i = (this.tokAt (0) == 134221832 ? 0 : 1);
var filter = null;
...
if (tok == 1745489933) this.setShapeProperty (6, "select", bs);
...
Clazz_defineMethod (c$, "cmdUnitcell", 
 function (i) {
this.getCmdExt ().dispatch (1613369372, i == 2, null);
}, "~N");
...
if ((token.intValue == 134320137 || token.intValue == 102436) && this.tokAt (this.iToken + 1) != 268435472) {
...
var isUserFunction = ($var.intValue == 134320137);
...
case 1073742327:
tok2 = 480;
if (this.tokAt (this.iToken + 3) == 1073742336 && this.tokAt (this.iToken + 4) == 1275068419) tok2 = 224;
case 32:
case 64:
case 192:
case 128:
...
i = this.iToken;
if ($var.intValue == 134320137 && tokNext != 268435472) {
rpn.addOp (JS.T.tokenLeftParen);
rpn.addOp (JS.T.tokenRightParen);
}break;
case 1086326786:
...
if (!rpn.addOp (JS.SV.newV (134320137, this.theToken.value))) this.invArg ();
if (!haveParens) {
rpn.addOp (JS.T.tokenLeftParen);
rpn.addOp (JS.T.tokenRightParen);
}} else {
...
if (tokWhat == 1639976963 || tokWhat == 1237320710 || tokWhat == 1086326789) isStringProperty = !(isIntProperty = (comparisonInt != 2147483647));
...
forceString = new Boolean (forceString | (JS.T.tokAttr (tok, 20480) || tok == 134222853)).valueOf ();
if (v == null) {
...
if (this.oPt >= 1 && op.tok != 268435472 && tok0 == 134217743) tok0 = this.oStack[--this.oPt].tok;
var newOp = null;
var isLeftOp = false;
switch (op.tok) {
case 1073742195:
...
switch (op.tok) {
case 268435665:
return (((op.intValue & -481) == 134320137 && op.intValue != 134320137) ? this.evaluateFunction (0) : true);
case 268435650:
case 268435649:
...
if (this.coordinatesAreFractional || this.tokAt (this.iToken + 1) == 1613369372) {
tickInfo.scale = JU.P3.new3 (NaN, NaN, NaN);
allowScale = false;
}if (this.tokAt (this.iToken + 1) == 1613369372) this.iToken++;
tickInfo.type = str;
if (this.tokAt (this.iToken + 1) == 1287653383) tickInfo.tickLabelFormats = this.stringParameterSet (this.iToken + 2);
...
function () {
var isScriptExpression = ((this.tokCommand == 134222853 || this.tokCommand == 4124) && this.tokAt (2) == 268435472);
this.isEmbeddedExpression = (isScriptExpression || (this.tokCommand != 0 && (this.tokCommand != 134320137 && this.tokCommand != 102436 && this.tokCommand != 364558 && this.tokCommand != 102412 || this.tokenCommand.intValue != 2147483647) && this.tokCommand != 102409 && !JS.T.tokAttr (this.tokCommand, 12288) && (this.nTokens > 2 || !JS.T.tokAttr (this.tokCommand, 20480))));
...
if (this.isNewSet) {
if (size == 1) {
this.atokenInfix[0] = JS.T.tv (134320137, 0, this.atokenInfix[0].value);
this.isNewSet = false;
...
if (this.tokPeekIs (1073741824) && !(this.tokCommand == 134222851 && this.itokenInfix == 1)) {
...
case 134217734:
case 1275203591:
return this.clauseConnected (tok == 1275203591);
case 134218759:
case 134218760:
return this.clauseSubstructure ();
case 134217749:
case 134353929:
return this.clauseWithin (tok == 134217749);
case 12290:
