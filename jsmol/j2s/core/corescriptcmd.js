...
break;
case 268435568:
if (this.tokAt (i + 1) != 134217734) this.invArg ();
i++;
isNotConnected = true;
break;
case 134217734:
...
i = eval.iToken;
if (!this.chk) list.addLast ( Clazz_newArray (-1, [Integer.$valueOf (134217744), Float.$valueOf (timeSec), pt]));
continue;
case 528432:
switch (this.getToken (++i).tok) {
case 1111492629:
...
var pt0 = (isReturnOnly || tokCmd == 134221842 || tokCmd == 4138 ? 0 : 1);
var filename = null;
...
if (this.tokAt (eval.iToken) == 1287653383) {
...
if (ptDataFrame > 0 && tokCmd != 134221846 && tokCmd != 134222350) {
...
}if (tokCmd == 134221846) return this.vwr.writeFileData (filename, "PLOT_" + type, modelIndex, parameters);
...
case 1073741879:
case 134218760:
this.checkLength (tok == 1073741879 || tok == 134218760 && this.tokAt (2) != 0 ? len = 3 : 2);
if (this.chk) return;
try {
if (tok != 134218760) {
