...
commands.append (";\n");
haveModulation = new Boolean (haveModulation | (this.vwr.ms.getLastVibrationVector (i, 1275072537) >= 0)).valueOf ();
}
...
if ((ivib = this.vwr.ms.getLastVibrationVector (i, 1275072537)) >= 0) for (var j = models[i].firstAtomIndex; j <= ivib; j++) {
