...
case 134217744:
case 1073742106:
var isPoints = (eval.theTok == 134217744);
propertyName = "polygon";
havePoints = true;
var v =  new JU.Lst ();
var nVertices = 0;
...
if (tokProperty != 1765808132) {
pt =  new JU.P3 ();
for (var iAtom = ac; --iAtom >= 0; ) data[iAtom] = atoms[iAtom].atomPropertyFloat (this.vwr, tokProperty, pt);

}}if (tokProperty == 1765808132) colorScheme = "inherit";
if (this.tokAt (i + 1) == 134217749) {
...
} else if (this.tokAt (i + 1) == 134217744) {
++i;
...
if (colorDensity || displayType != 1275068936) {
...
mesh.getMeshSlicer ().getIntersection (0, data[1], null, data[2], null, null, null, false, false, 134217743, false);
return true;
...
if (Clazz_instanceOf (plane, JU.P4)) return JU.TempArray.getSlabObjectType (134217743, plane, isCap, null);
} catch (e) {
if (Clazz_exceptionOf (e, Exception)) {
} else {
throw e;
