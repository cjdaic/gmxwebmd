...
this.sg.initState ();
this.newSurface (134217743, null, bsA, bsB, rd, parameters, func, colorDensity, this.sg.volumeDataTemp, 0);
this.mergeMesh (null);
break;
case 1073741961:
case 1275068936:
colorByType = false;
this.newSurface (1275068936, null, bsA, bsB, rd, null, null, colorDensity, null, 0);
if (displayType == 1073741961) {
this.sg.initState ();
this.newSurface (1275068936, null, bsB, bsA, rd, parameters, func, colorDensity, null, 0);
this.mergeMesh (null);
} else {
...
var isVdwClash = (displayType == 134217743 && (contactType == 1648363544 || contactType == 0) && cp.setForVdwClash (true));
