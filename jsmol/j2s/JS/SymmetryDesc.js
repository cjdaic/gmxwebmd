...
if (pt2 != null) return this.getSymmetryInfoString (sym, iModel, op, pt, pt2, (id == null ? "sym" : id), type == 1825200140 ? "label" : null, modelSet);
var isBio = uc.isBio ();
var iop = op;
var centering = null;
if (xyz == null) {
...
case 1073741854:
case 134217743:
return ((ang == 0) == (type == 134217743) ? info[8] : null);
case 134217729:
return info[9];
case 12:
return info[10];
